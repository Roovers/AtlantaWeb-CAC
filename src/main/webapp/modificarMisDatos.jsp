    ...
    <div class="form-container">
        <div class="form-content">
            ...
            <div class="form-messages">
                ...
                <%
                    // Obtener mensajes de la solicitud
            ...
            <form action="modificarMisDatos" method="post">
                <h1>EDITAR DATOS</h1>
                ...
                <div class="form-input">
                    ...
                    <input type="text" id="nombre" name="nombre" placeholder="Ingresa tu nombre"
                           value="<%= ((Usuario) session.getAttribute("usuarioModificar")).getNombre() %>" required>
                </div>
                ...
                <div class="form-input">
                    ...
                    <input type="text" id="apellido" name="apellido" placeholder="Ingresa tu apellido"
                           value="<%= ((Usuario) session.getAttribute("usuarioModificar")).getApellido() %>" required>
                </div>
                ...
                <div class="form-input">
                    ...
                    <input type="email" id="correo" name="correo" placeholder="Ingresa tu correo"
                           value="<%= ((Usuario) session.getAttribute("usuarioModificar")).getCorreo() %>" required>
                </div>
                ...
                <div class="form-buttons">
                    <button type="submit" id="agregar"><i class="fas fa-plus-circle"></i> Guardar Cambios</button>
