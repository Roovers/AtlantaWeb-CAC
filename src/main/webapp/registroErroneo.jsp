...
<div class="container" id="error">
  <h1>HUBO UN ERROR EN SU REGISTRO</h1>
  <h1>O YA EXISTE UNA CUENTA CON </h1>
  <h1>ESTOS DATOS</h1>
...
<footer class="container-fluid bg-dark py-4 fixed-bottom">
  <div class="container">
    ...
    <p class="copyright" style="text-align: center; font-size: 12px;">Todos los derechos reservados © Juan Cruz Roovers
      2023</p>
  </div>
</footer>
