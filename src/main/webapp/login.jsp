...
<%
    HttpSession currentSession = request.getSession(false); // No crea una nueva sesión si no existe
    ...
    <div class="form-container">
        <div class="form-container">
            <div class="form-content">
                <form action="/ClubAtleticoAtlanta/LoginServlet" method="post">
                    <h1>L O G I N</h1>
                    ...
                    <div class="form-buttons">
                        <button type="submit" id="agregar"><i class="fas fa-plus-circle"></i> Login</button>
                    </div>
                </form>
            </div>
        </div>
