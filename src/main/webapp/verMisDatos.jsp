...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/verMisDatos.css">
...
<div class="container" id="exito">
    ...
    <h1>Bienvenido, <%= ((Usuario) session.getAttribute("usuario")).getNombre() %>
        <%= ((Usuario) session.getAttribute("usuario")).getApellido() %>!</h1>
    <img class="carnet-icon" src="./Img/carn.png" alt="Logo de el club atlanta"
         width="220px" height="150px">
    <!-- Mostrar los detalles del usuario -->
    <div class="container" id="error">
        <p>Nombre: <%= ((Usuario) session.getAttribute("usuario")).getNombre() %>
        </p>
        <p>Apellido: <%= ((Usuario) session.getAttribute("usuario")).getApellido() %>
        </p>
        <p>DNI: <%= ((Usuario) session.getAttribute("usuario")).getDni() %>
        </p>
        <p>Correo: <%= ((Usuario) session.getAttribute("usuario")).getCorreo() %>
        </p>
    </div>


    <% } else { %>
    <p>Debes iniciar sesión para ver esta página. Redirigiendo a la página de inicio de sesión...</p>
    <% response.sendRedirect("login.jsp"); %>
    <% } %>
</div>

<div class="botones-carnet">
    <a href="/ClubAtleticoAtlanta/modificarMisDatos">
        <i class="fas fa-edit"></i> Modificar Mis Datos
    </a>
    <a href="/ClubAtleticoAtlanta/darDeBaja">
        <i class="fas fa-user-times"></i> Dar de baja mi Usuario
    </a>

    <!-- Botón de cerrar sesión -->
    <a href="/ClubAtleticoAtlanta/cerrarSesion">
