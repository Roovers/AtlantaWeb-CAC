...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/plantillaUser.css">
...
<div class="container" id="exito">
    <h1>Bienvenido, <%= session.getAttribute("nombreUsuario") %> <%= session.getAttribute("apellidoUsuario") %>!</h1>
    <a href="verMisDatos">Ver Mis Datos</a>
    <a href="modificarMisDatos">Modificar Mis Datos</a>
    <a href="darDeBajaUsuario">Dar de baja mi Usuario</a>
