...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/registro-exitoso.css">
...
<div class="container" id="exito">
    <h1>TUS CAMBIOS SE GUARDARON CORRECTAMENTE</h1>
...
<!-- Footer con clase fixed-bottom para fijar al fondo -->
<footer class="container-fluid bg-dark py-4 fixed-bottom">
    <div class="container">
        ...
        <!-- <hr> No es necesario el hr, ya que separamos los elementos con el sistema de grillas de Bootstrap -->
        <p class="copyright" style="text-align: center; font-size: 12px;">Todos los derechos reservados © Juan Cruz
            Roovers 2023</p>
    </div>
</footer>

<!-- Agregar la referencia de Bootstrap JS (opcional) -->
